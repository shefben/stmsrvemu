...
def load_modifiers_from_files():
    file_paths = {"suggestion_prepend.txt":[], "suggestion_append.txt":[]}
    ...
    if config["use_builtin_suggested_name_modifiers"].lower() == "true":
        globalvars.prepended_modifiers += ["mc", "cool", "star", "pro", "king", "ninja", "ace", "neo", "tech", "nova", "sky", "galaxy", "phantom", "Mr_", "elite", "shadow", "cyber", "quantum", "ethereal", "mystic", "wizard", "echo", "terra", "aqua", "pyro", "frost", "thunder", "drift", "flux", "banned", "dumb", "generic_", "gooey", "stinky", "raunchy", "putrid", "brother_", "nasty", "ultra", "mega", "super", "hyper", "dark", "chaos", "lucky", "quick", "sneaky", "crazy", "furious", "silent", "rapid", "chronic", "stormy", "wild", "ancient", "legendary", "ghost", "frosty", "the_phallic", "hard", "crunchy", "ugly", "crunchy", "re"]
        globalvars.appended_modifiers += ["rific", "dream", "_the_womanizer", "transvester", "_the_unlikable", "_the_terrible", "orama", "ler", "ing", "son", "_jr", "ifier", "ny", "y", "ji", "man", "zilla", "nator", "saures", "ton", "ious", "zen", "wick", "son", "leigh", "wood", "smith", "max", "dex", "ley", "nator", "able", "stein", "knight", "_the_cog", "s_boner", "_the_pipelayer"]
