...
class UserRegistryBuilder(BlobBuilder) :
    ...
    def beta1_InsertBaseUserRegistryInformation(self, UniqueUsername, AccountCreationTime,
    ...
    def beta1_add_account_subscription(self, subscription_id,
    ...
    def add_account_subscription_beta1(self, subscription_id,
                                       subscribed_date, unsubscribed_date) :
        subscription_entry = {
            b"\x01\x00\x00\x00" : subscribed_date,
            b"\x02\x00\x00\x00" : unsubscribed_date,
