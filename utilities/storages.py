...
class Storage(object):
	def __init__(self, storagename, path, version, islan=False):
		...
		if path.endswith("storages/") :
			...
			print("Path to storages directory is not set to files/storages!")
			return
		...
		if os.path.isfile("files/cache/" + self.name + "_" + self.ver + "/" + self.name + "_" + self.ver + ".manifest") :
			...
			self.indexfile  = "files/cache/" + self.name + "_" + self.ver + "/" + self.name + suffix + ".index"
			self.datafile   = "files/cache/" + self.name + "_" + self.ver + "/" + self.name + suffix + ".data"
