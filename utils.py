...
def readfile_beta(fileid, offset, length, index_data, dat_file_handle, net_type):
    ...
    oldstringlist1 = (b'"hlmaster.valvesoftware.com:27010"', b'"half-life.east.won.net:27010"', b'"gridmaster.valvesoftware.com:27012"', b'"half-life.west.won.net:27010"', b'"207.173.177.10:27010"')
    oldstringlist2 = (b'"tracker.valvesoftware.com:1200"', b'"tracker.valvesoftware.com:1200"')
    oldstringlist3 = (b'207.173.177.10:7002', b'half-life.speakeasy-nyc.hlauth.net:27012', b'half-life.speakeasy-sea.hlauth.net:27012', b'half-life.speakeasy-chi.hlauth.net:27012')
...
def finalinitialize(log):
    ...
    if globalvars.steamui_ver < 122:
        if os.path.isfile("files/cafe/Steam.dll"):
            ...
            cafe_neutering.process_cafe_files("files/cafe/Steam.dll", "files/cafe/CASpackage.zip", "client/cafe_server/CASpackageWAN.zip", "client/cafe_server/CASpackageLAN.zip", "files/cafe/README.txt", "client/Steam.exe", config)
