...
class CSERServer(UDPNetworkHandler):
    ...
    def __init__(self, port, config):
        ...
        self.handlers = {b'e':self.parse_steamstats, b'c':self.parse_crashreport, b'q':self.parse_encryptedbugreport, b'p':self.parse_unknownp, b'a':self.parse_downloadstats, b'o':self.parse_bugreport, b'i':self.handle_unknown_stats, b'k':self.parse_gamestats, b'm':self.parse_phonehome, b'g':self.parse_surveyresults}
    ...
    def parse_phonehome(self, address, data, clientid, log):
        ...
        if session_id != 0 and not is_match:
            ...
            extracted_data = {"protocol_version":protocol_version, "session_id":session_id, "encrypted_length":encrypted_length, "corruption_id":corruption_id, "unique_id":unique_id, "computer_name":computer_name, "username":username, "game_dir":game_dir, "engine_timestamp":engine_timestamp, "message_type":message_type}
