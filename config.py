...
def read_config():
    ...
    myDefaults = {'public_ip': "0.0.0.0", 'log_level': 'logging.INFO', 'log_to_file': "true", 'hldsupkg': "", 'steamver': "v2",
                  ...
                  'database_password': "", 'database_database': "stmserver", 'database_host': "localhost",  'contentdir_server_port': "27037",
                  ...
                  'betamanifestdir': "files/betamanifests/", 'betastoragedir': "files/betastorages/", 'server_sm': "255.255.255.0", 'server_ip': "127.0.0.1",
