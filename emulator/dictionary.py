...
contentdescription_record = {
    ...
    'ApplicationsRecord': {'key': r'\x01\x00\x00\x00', 'value': r''},
    'SubscriptionsRecord': {'key': r'\x02\x00\x00\x00', 'value': r''},
    'LastChangedExistingAppOrSubscriptionTime': {'key': r'\x03\x00\x00\x00', 'value': r''},
    'IndexAppIdToSubscriptionIdsRecord': {'key': r'\x04\x00\x00\x00', 'value': r''},
    'AllAppsPublicKeysRecord': {'key': r'\x05\x00\x00\x00', 'value': r''},
    'AllAppsEncryptedPrivateKeysRecord': {'key': r'\x06\x00\x00\x00', 'value': r''},
}
...
CDRapplication_record = {
    ...
    'LaunchOptionsRecord': {'key': r'\x06\x00\x00\x00', 'value': r''},
    ...
    'VersionsRecord': {'key': r'\x0a\x00\x00\x00', 'value': r''},
    'CurrentVersionId': {'key': r'\x0b\x00\x00\x00', 'value': r''},
    'FilesystemsRecord': {'key': r'\x0c\x00\x00\x00', 'value': r''},
    'TrickleVersionId': {'key': r'\x0d\x00\x00\x00', 'value': r''},
    'UserDefinedRecord': {'key': r'\x0e\x00\x00\x00', 'value': r''},
...
CDRapplicationversion_record = {
    ...
    'LaunchOptionIdsRecord': {'key': r'\x04\x00\x00\x00', 'value': r''},
