...
("",
 "30819d300d06092a864886f70d010101050003818b0030818702818100" + config["net_key_n"][2:] + "020111",
 "Steam1 unknown RSA key (512-bit), not replaced yet"),
...
('http://www.steampowered.com/platform/update_history/"',
 "http://" + config["http_ip"] + http_port_neuter + '/platform/update_history/"',
 "Platform News URL"),
("http://www.steampowered.com/platform/banner/random.php",
 "http://" + config["http_ip"] + http_port_neuter + "/platform/banner/random.php",
 "Banner URL"),
("http://storefront.steampowered.com/platform/update_history/index.php",
 "http://" + config["http_ip"] + http_port_neuter + config["store_url_new"] + "/platform/update_history/index.php",
 "Client news URL"),
("http://www.steampowered.com/?area=news",
 "http://" + config["http_ip"] + http_port_neuter + "/?area=news",
 "Steam news URL 1"),
("http://www.steampowered.com/index.php?area=news",
 "http://" + config["http_ip"] + http_port_neuter + "/index.php?area=news",
 "Steam news URL 2"),
("http://www.steampowered.com/platform/friends/",
 "http://" + config["http_ip"] + http_port_neuter + "/platform/friends/",
 "Tracker URL"),
("http://www.steampowered.com/index.php?area=subscriber_agreement",
 "http://" + config["http_ip"] + http_port_neuter + "/index.php?area=subscriber_agreement",
 "SSA URL"),
('http://storefront.steampowered.com/v/?client=1',
 "http://" + config["http_ip"] + http_port_neuter + "/v/?client=1",
 "Storefront URL 1"),
("http://storefront.steampowered.com",
 "http://" + config["http_ip"] + http_port_neuter + config["store_url_new"],
 "Storefront URL 2"),
("http://support.steampowered.com",
 "http://" + config["http_ip"] + http_port_neuter + config["support_url_new"],
 "Support URL"),
...
("http://www.steampowered.com",
 "http://" + config["http_ip"] + http_port_neuter,
 "Steampowered URL 1"),
...
("http://www.steampowered.com/platform/banner/",
 "http://" + config["http_ip"] + http_port_neuter + "/platform/banner/",
 "New banner URL 1"),
("http://cdn.steampowered.com/platform/banner/cs_25.html",
 "http://" + config["http_ip"] + http_port_neuter + "/platform/banner/cs_25.html",
 "New banner URL 2"),
...
("http://steampowered.com/img/steam_logo_onwhite.gif",
 "http://" + config["http_ip"] + http_port_neuter + "/img/steam_logo_onwhite.gif",
 "New account logo 1"),
("http://steampowered.com/img/print.gif",
 "http://" + config["http_ip"] + http_port_neuter + "/img/print.gif",
 "New account logo 2"),
...
("http://steampowered.com/troubleshooter/",
 "http://" + config["http_ip"] + http_port_neuter + "/troubleshooter/",
 "Troubleshooter"),
